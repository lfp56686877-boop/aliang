...
const milestones: Milestone[] = [
  { year: '2019', title: 'Company Founded', description: 'China Medical Devices established in China, starting with a vision to bridge global healthcare with Chinese manufacturing.' },
    ...
    <main className="min-h-screen bg-[#F8FAFC]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-[#64748B] leading-relaxed mb-6">
                Founded in 2019, China Medical Devices leverages over 20 years of deep expertise in the medical device industry. We understand China&apos;s complex manufacturing landscape and help global healthcare providers navigate it with confidence.
              </p>
              <p className="text-[#64748B] leading-relaxed mb-6">
              ...
              <a
                href="https://wa.me/8618669317333?text=Hello, I'd like to learn more about China Medical Devices."
                target="_blank"
      ...
      <section className="py-16 bg-gradient-to-br from-[#1E40AF] via-[#2563EB] to-[#3B82F6]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a
            href="https://wa.me/8618669317333?text=Hello, I'd like to discuss a partnership with China Medical Devices."
            target="_blank"
            rel="noopener noreferrer"

...
export function ScalpelIcon({ className, size = 24 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
// Medical Product Category Icons - Blue outline style matching Weigao
const iconProps = { className: "w-10 h-10 text-[#2563EB]", strokeWidth: 1.5 };

export function ConsumablesIcon({ className = iconProps.className }: IconProps) {
  return (
...
export function OrthopedicIcon({ className = iconProps.className }: IconProps) {
  return (
    <svg className={className} width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2v20" />
...
export function DiagnosticIcon({ className = iconProps.className }: IconProps) {
  return (
    <svg className={className} width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
      <circle cx="12" cy="12" r="10" />
...
export function MonitoringIcon({ className = iconProps.className }: IconProps) {
  return (
    <svg className={className} width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
...
export function IVDIcon({ className = iconProps.className }: IconProps) {
  return (
    <svg className={className} width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
      <path d="M9 3h6" />
      <path d="M12 3v7l-5 8h10l-5-8V3" />
      <path d="M8 14h8" />
    </svg>
  );
}

export function DentalIcon({ className = iconProps.className }: IconProps) {
  return (
    <svg className={className} width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2C8 2 5 5 5 9c0 3 1 5 2 7 1 2 2 6 5 6s4-4 5-6c1-2 2-4 2-7 0-4-3-7-7-7z" />
      <path d="M9 9h6" />
    </svg>
  );
}

export function OphthalmicIcon({ className = iconProps.className }: IconProps) {
  return (
    <svg className={className} width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
...
export function RehabilitationIcon({ className = iconProps.className }: IconProps) {
  return (
    <svg className={className} width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
...
export function RespiratoryIcon({ className = iconProps.className }: IconProps) {
  return (
    <svg className={className} width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2v6" />
      <path d="M8 8c-2 0-4 2-4 4s2 4 4 4" />
      <path d="M16 8c2 0 4 2 4 4s-2 4-4 4" />
      <path d="M12 18v4" />
    </svg>
  );
}

export function LaboratoryIcon({ className = iconProps.className }: IconProps) {
  return (
    <svg className={className} width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
      <path d="M9 3h6" />
      <path d="M10 3v7L5 20h14l-5-10V3" />
    </svg>
  );
}

export function InterventionalIcon({ className = iconProps.className }: IconProps) {
  return (
    <svg className={className} width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2v20" />
      <path d="M8 6l4-4 4 4" />
...
export function BloodIcon({ className = iconProps.className }: IconProps) {
  return (
    <svg className={className} width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
...
export function EndoscopyIcon({ className = iconProps.className }: IconProps) {
  return (
    <svg className={className} width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
...
export function ImagingIcon({ className = iconProps.className }: IconProps) {
  return (
    <svg className={className} width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
...
export function ReproductionIcon({ className = iconProps.className }: IconProps) {
  return (
    <svg className={className} width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
...
export function MedicalITIcon({ className = iconProps.className }: IconProps) {
  return (
    <svg className={className} width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
      <rect x="2" y="3" width="20" height="14" rx="2" />
      <path d="M8 21h8" />
...
export function SterilizationIcon({ className = iconProps.className }: IconProps) {
  return (
    <svg className={className} width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
